...
.PARAMETER Clean
Removes the image testwebapi and kills all containers based on that image.
...
Build a Docker image named testwebapi
#>
...
$imageName="testwebapi"
$projectName="testwebapi"
$serviceName="testwebapi"
